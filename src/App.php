...
namespace CAP\Framework;

use Pimple\Container;
use CAP\Framework\Exceptions\HttpException;
use CAP\Framework\Response;
use CAP\Framework\Router;
use CAP\Framework\Modules\ModuleRegistry;
...
class App
{
    ...
    public function run()
    {
        try {
            ...
            echo $this->container['exception'] = $e;
